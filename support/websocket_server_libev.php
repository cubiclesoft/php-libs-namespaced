...
?><?php
	...
	if (!class_exists("\\CubicleSoft\\WebSocketServer", false))  require_once str_replace("\\", "/", dirname(__FILE__)) . "/websocket_server.php";

	class LibEvWebSocketServer extends \CubicleSoft\WebSocketServer
	{
