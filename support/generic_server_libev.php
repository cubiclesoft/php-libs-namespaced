...
?><?php
	...
	if (!class_exists("\\CubicleSoft\\GenericServer", false))  require_once str_replace("\\", "/", dirname(__FILE__)) . "/generic_server.php";

	class LibEvGenericServer extends \CubicleSoft\GenericServer
	{
