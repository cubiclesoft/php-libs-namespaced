...
?><?php
	...
	class CSDB_oci extends \CubicleSoft\CSDB
	{
		protected $lastid;
...
// This function also isn't in use anywhere...
		...
		{
			return \CubicleSoft\CSDB::DB_Translate("Oracle (via PDO) - Early beta");
		}
...
// A random PostgreSQL reference...is this comment relevant to Oracle/OCI?
		...
		protected function RunStatementFilter(&$stmt, &$filteropts)
		{
			if ($filteropts["mode"] == "INSERT")
			{
				...
				$result = new \CubicleSoft\CSDB_PDO_Statement($this, $stmt, $filteropts);
				$row = $result->NextRow();
