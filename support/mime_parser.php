...
?><?php
	...
	class MIMEParser
	{
		...
		public static function ConvertFromRFC1342($data)
		{
			...
			while ($pos !== false && $pos2 !== false && $pos3 !== false && $pos4 !== false)
			{
				...
				else
				{
					...
					$data2 = \CubicleSoft\UTF8::MakeValid(trim($data2));
				}
		...
		public static function ConvertCharset($data, $incharset, $outcharset)
		{
			...
			if ($incharset == "UTF-8")  $data = \CubicleSoft\UTF8::MakeValid($data);
		...
		public static function Parse($data, $depth = 0)
		{
			...
			{
				$result["body"] = \CubicleSoft\UTF8::MakeValid($data);
				$result["mime"] = array();
			}
			else
			{
				...
				else
				{
					...
					$result["body"] = \CubicleSoft\UTF8::MakeValid($data[0]);
					$result["mime"] = array();
					$y = count($data);
					for ($x = 1; $x < $y; $x++)
					{
